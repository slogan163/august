...
public class AugustwokshopsTestContainer extends TestContainer {

    public AugustwokshopsTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/augustwokshops/app.properties",
    ...
    public static class Common extends AugustwokshopsTestContainer {

        public static final AugustwokshopsTestContainer.Common INSTANCE = new AugustwokshopsTestContainer.Common();
